        ...
        <section id="experience">
            ...
            <hr/>
                ...
                <ul>
                    ...
                    <li>Write a safe, iterative metadata sorting algorithm to improve search preformance for Blankos Marketplace metadata</li>
            ...
            <div className="job">
                ...
                <ul>
                    <li>Expland python scripting API to enable users to script and record their geometric model designs for 3D modeling engine SpaceClaim (C# .NET, WPF)</li>
